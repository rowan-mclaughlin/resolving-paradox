...
In the following plot, both normal and bootstapped versions of the moving average model are presented. The uncertainty of the bootstrapped version, which is of a greater magnitude, reflects the variability in the data as well as its inherant chronological uncertainty. 
